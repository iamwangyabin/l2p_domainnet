...
def get_config():
    ...
    config.task_specific_cls_token = True   # default False
    ...
    config.prompt_pool_param.use_prompt_mask = False  # defaule False
    ...
    config.pull_constraint = True # default true
    config.pull_constraint_coeff = 0.001
